...
u8 USART1_RX_BUF[USART1_REC_LEN] __attribute__ ((at(0X20001000)));//接收缓冲,最大USART1_REC_LEN个字节,起始地址为0X20001000.  
...
void USART1_IRQHandler(void)      //串口1中断服务程序
{
	...
	{
		x=USART_ReceiveData(USART1);	//读取接收到的信息
		if(USART1_RX_CNT<USART1_REC_LEN)
		{
			USART1_RX_BUF[USART1_RX_CNT]=x;
			USART1_RX_CNT++;			 									     
		} 
